...
public class GridPanel extends JPanel {
	...
	public GridPanel() {
		...
		shapes = new ShapeLabel[] {
				new ShapeLabel("/purpleTriangle.jpg", 0, -1, -1),
				new ShapeLabel("/blueDropper.png", 1, -1, -1),
				new ShapeLabel("/greenOctagon.jpg", 2, -1, -1),
				new ShapeLabel("/orangeHexagon.jpg", 3, -1, -1),
				new ShapeLabel("/redSquare.jpg", 4, -1, -1),
				new ShapeLabel("/whiteCircle.jpg", 5, -1, -1),
				new ShapeLabel("/yellowTriangle.png", 6, -1, -1) };
